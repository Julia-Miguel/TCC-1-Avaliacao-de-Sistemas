...
avaliacaoRouter.post('/avaliacao', createAvaliacaoController.handle);

// GET ALL
const getAllAvaliacaoController = new GetAllAvaliacaoController();
avaliacaoRouter.get('/avaliacao', getAllAvaliacaoController.handle);

// GET BY ID
const getByIdAvaliacaoController = new GetByIdAvaliacaoController();
avaliacaoRouter.get('/avaliacao/:id', getByIdAvaliacaoController.handle);

// Update
const updateAvaliacaoController = new UpdateAvaliacaoController();
avaliacaoRouter.put('/avaliacao', updateAvaliacaoController.handle);

// Delete
const deleteAvaliacaoController = new DeleteAvaliacaoController();
avaliacaoRouter.delete('/avaliacao', deleteAvaliacaoController.handle);
