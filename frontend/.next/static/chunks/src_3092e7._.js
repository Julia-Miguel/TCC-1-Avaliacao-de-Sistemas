(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_3092e7._.js", {
...
function EditQuestionarioFormContent() {
    ...
    const [respostasSubView, setRespostasSubView] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('dashboard');
    ...
    const [filtroAvaliacaoId, setFiltroAvaliacaoId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('all'); // 'all' ou o ID da avaliação
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditQuestionarioFormContent.useEffect": ()=>{
            ...
            if (viewMode === 'respostas' && questionarioId) {
                ...
                setError(null);
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/questionarios/${questionarioId}/avaliacoes-com-respostas`).then({
                    "EditQuestionarioFormContent.useEffect": (response)=>{
                        setAvaliacoesComRespostas(response.data.sort({
                            "EditQuestionarioFormContent.useEffect": (a, b)=>new Date(b.created_at).getTime() - new Date(a.created_at).getTime()
                        }["EditQuestionarioFormContent.useEffect"]));
                    }
    ...
    const dadosProcessadosParaDashboard = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "EditQuestionarioFormContent.useMemo[dadosProcessadosParaDashboard]": ()=>{
            if (avaliacoesComRespostas.length === 0) return [];
            const avaliacoesFiltradas = filtroAvaliacaoId === 'all' ? avaliacoesComRespostas : avaliacoesComRespostas.filter({
                "EditQuestionarioFormContent.useMemo[dadosProcessadosParaDashboard]": (av)=>av.id === Number(filtroAvaliacaoId)
            }["EditQuestionarioFormContent.useMemo[dadosProcessadosParaDashboard]"]);
    ...
    const kpis = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "EditQuestionarioFormContent.useMemo[kpis]": ()=>{
            const avaliacoesFiltradas = filtroAvaliacaoId === 'all' ? avaliacoesComRespostas : avaliacoesComRespostas.filter({
                "EditQuestionarioFormContent.useMemo[kpis]": (av)=>av.id === Number(filtroAvaliacaoId)
            }["EditQuestionarioFormContent.useMemo[kpis]"]);
            let totalRespondentes = 0;
            let finalizados = 0;
            avaliacoesFiltradas.forEach({
                "EditQuestionarioFormContent.useMemo[kpis]": (av)=>{
                    totalRespondentes += av.usuarios.length;
                    av.usuarios.forEach({
                        "EditQuestionarioFormContent.useMemo[kpis]": (u)=>{
    ...
    const handlePerguntaChange = (qIndex, novoEnunciado)=>setQuePergs((prev)=>prev.map((qp, i)=>i === qIndex ? {
                    ...qp,
                    pergunta: {
                        ...qp.pergunta,
    ...
    const handleTipoChange = (qIndex, novoTipo)=>setQuePergs((prev)=>prev.map((qp, i)=>i === qIndex ? {
                    ...qp,
                    pergunta: {
                        ...qp.pergunta,
                        tipos: novoTipo,
                        opcoes: novoTipo === 'TEXTO' ? [] : qp.pergunta.opcoes.length > 0 ? qp.pergunta.opcoes : [
                            {
                                texto: '',
                                tempId: `opt-0`
                            }
    ...
    const handleOptionChange = (qIndex, oIndex, novoTexto)=>setQuePergs((prev)=>prev.map((qp, i)=>i === qIndex ? {
                    ...qp,
                    pergunta: {
                        ...qp.pergunta,
                        opcoes: qp.pergunta.opcoes.map((o, oi)=>oi === oIndex ? {
                                ...o,
                                texto: novoTexto
                            } : o)
                    }
                } : qp));
    const addOptionToList = (qIndex)=>setQuePergs((prev)=>prev.map((qp, i)=>i === qIndex ? {
                    ...qp,
                    pergunta: {
                        ...qp.pergunta,
                        opcoes: [
                            ...
                            {
                                texto: '',
                                tempId: `opt-${qp.pergunta.opcoes.length}`
                            }
                        ]
                    }
                } : qp));
    const removeOption = (qIndex, oIndex)=>setQuePergs((prev)=>prev.map((qp, i)=>i === qIndex ? {
                    ...qp,
                    pergunta: {
                        ...qp.pergunta,
                        opcoes: qp.pergunta.opcoes.filter((_, oi)=>oi !== oIndex)
                    }
                } : qp));
    const handleAddNewPergunta = ()=>setQuePergs((prev)=>[
                ...prev,
                {
                    questionarioId,
                    pergunta: {
    ...
    if (error && !titulo) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "page-container center-content",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
        ...
        children: [
            ...
            viewMode === 'editar' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    children: "Seu formulário de edição de perguntas e título aparece aqui."
                }, void 0, false, {
                    fileName: "[project]/src/app/questionarios/[id]/page.tsx",
                    lineNumber: 242,
                    columnNumber: 21
            ...
            viewMode === 'respostas' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                children: [
                    isLoadingRespostas && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    !isLoadingRespostas && error && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-center py-8 error-message",
                        children: error
                    }, void 0, false, {
                        fileName: "[project]/src/app/questionarios/[id]/page.tsx",
                        lineNumber: 250,
                    ...
                    !isLoadingRespostas && avaliacoesComRespostas.length === 0 && !error && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: "Nenhuma resposta foi submetida para este questionário ainda."
                            }, void 0, false, {
                                fileName: "[project]/src/app/questionarios/[id]/page.tsx",
                                lineNumber: 255,
                                columnNumber: 29
                    ...
                    !isLoadingRespostas && avaliacoesComRespostas.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "flex flex-col sm:flex-row items-center justify-between mb-6 p-4 bg-element-bg rounded-lg border border-border",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                        value: "all",
                                                        children: "Todas as Avaliações"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/questionarios/[id]/page.tsx",
                                                        lineNumber: 271,
                                                        columnNumber: 41
                                                    }, this),
                                                    avaliacoesComRespostas.map((av)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                            value: av.id,
                                                            children: [
                                                                av.semestre,
                                                                " - ",
                                                                av.descricao || `(ID: ${av.id})`
                                                            ]
                                                        }, av.id, true, {
                                                            fileName: "[project]/src/app/questionarios/[id]/page.tsx",
                                                            lineNumber: 273,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        onClick: ()=>setRespostasSubView(respostasSubView === 'dashboard' ? 'individuais' : 'dashboard'),
                            ...
                            respostasSubView === 'dashboard' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "kpi-value",
                                                        children: kpis.totalRespondentes
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/questionarios/[id]/page.tsx",
                                                        lineNumber: 290,
                                                        columnNumber: 67
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "kpi-label",
                                                        children: "Respostas Finalizadas"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/questionarios/[id]/page.tsx",
                                                        lineNumber: 291,
                                                        columnNumber: 120
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: dadosProcessadosParaDashboard.map(([perguntaId, dados])=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            respostasSubView === 'individuais' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "space-y-4",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                        className: "text-xl font-semibold",
                                        children: "Respostas Individuais"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/questionarios/[id]/page.tsx",
                                        lineNumber: 313,
                                        columnNumber: 38
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: "A lista detalhada de respostas individuais apareceria aqui."
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/questionarios/[id]/page.tsx",
                                        lineNumber: 315,
                                        columnNumber: 38
...
_s(EditQuestionarioFormContent, "AbQJFLE+IiODIzgZR8Kvwf6/OO0=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
...
//# sourceMappingURL=src_3092e7._.js.map