...
function EditQuestionarioFormContent() {
    ...
    const handleSaveChanges = async (e)=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].patch(`/questionarios/${params.id}`, {
                titulo
            });
            ...
            await Promise.all(perguntasExistentes.map((qp)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].patch(`/perguntas/${qp.pergunta.id}`, {
                    ...qp.pergunta
                })));
            // 4. CRIA apenas as perguntas que são realmente novas.
            //    Esta é a correção principal para o erro 400.
            if (perguntasNovas.length > 0) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`/perguntas/create-many`, {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__e9a417._.js.map